    ...
    return (
        <Card>
            <Card.Body className="text-center">
                ...
                <div>
                    <img src={'contact'} alt="profileImage" className="rounded-circle avatar-xl img-thumbnail mb-2" />
                    <p className="text-muted font-13 mb-3">p </p>
                    <div className="text-start">
                        ...
                        <p className="text-muted font-13">
                            <strong>Location :</strong> <span className="ms-2">contact.locatio</span>
                        </p>
                    </div>
