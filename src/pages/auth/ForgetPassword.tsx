...
const ForgetPassword = () => {
    ...
    const { loading, passwordReset, resetPasswordSuccess, error } = appSelector((state: any) => ({
        loading: state.Auth.user.loading,
        user: state.Auth.user.data,
        error: state.Auth.user.error,
        passwordReset: state.Auth.user.passwordReset,
        resetPasswordSuccess: state.Auth.user.resetPasswordSuccess,
    }));
